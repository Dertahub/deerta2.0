...
;(function ($, window, document, undefined) {
    ...
    Slide.prototype = {
        ...
        loadDom: function () {
            ...
            var panelHtml = '';
            var wrapHtml = '';
            var blankImg = Fast.api.cdnurl('/assets/img/blank.gif');
            ...
            panelHtml += `<div class="verify-img-out">
							<div class="verify-img-panel">
								...
								<img src="${blankImg}" class="backImg" style="width:100%;height:100%;display:block">
							</div>
						</div>`;
									...
									<div class="verify-left-bar">
										...
										<div  class="verify-move-block">
											...
											<div class="verify-sub-block">
												<img src="${blankImg}" class="bock-backImg" alt=""  style="width:100%;height:100%;display:block">
											</div>
										</div>
									</div>
								</div>`;
