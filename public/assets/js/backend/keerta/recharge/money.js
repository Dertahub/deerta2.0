define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'keerta/recharge/money/index' + location.search,
                    add_url: 'keerta/recharge/money/add',
                    edit_url: 'keerta/recharge/money/edit',
                    del_url: 'keerta/recharge/money/del',
                    multi_url: 'keerta/recharge/money/multi',
                    import_url: 'keerta/recharge/money/import',
                    table: 'keerta_money',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'is_first', title: __('是否首充'), searchList: {"1":__('是'),"0":__('否')}, formatter: Table.api.formatter.label},
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-edit',
                                    url: 'keerta/recharge/money/edit',
