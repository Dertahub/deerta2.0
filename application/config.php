...
return [
    ...
    'cache'                  => [
        ...
        'redis'   =>  [
            ...
            // 数据库
            'select' => Env::get('app.REDIS_DB', 0),
            // 缓存前缀
            'prefix' => Env::get('app.CACHE_PREFIX', 'new_cache'),
            // 缓存有效期 0表示永久缓存
            'expire' => 0,
        ],
    ],
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'eWQ621CwXRBionIm7MsahbUzVOxFSELd',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'fastadmin'              => [
        ...
        //允许跨域的域名,多个以,分隔
        'cors_request_domain'   => 'localhost,127.0.0.1,www.roghkr.cn,kefu.roghkr.cn',
        //版本号
