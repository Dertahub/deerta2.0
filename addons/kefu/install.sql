...
INSERT IGNORE INTO `__PREFIX__kefu_config` VALUES ('25', 'uni_push_switch', '0');
INSERT IGNORE INTO `__PREFIX__kefu_config` VALUES ('26', 'uni_push_appid', '');
INSERT IGNORE INTO `__PREFIX__kefu_config` VALUES ('27', 'uni_push_appkey', '');
INSERT IGNORE INTO `__PREFIX__kefu_config` VALUES ('28', 'uni_push_master_secret', '');
INSERT IGNORE INTO `__PREFIX__kefu_config` VALUES ('29', 'package_name_android', '');
COMMIT;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_csr_config` (
    ...
    `last_reception_time` bigint(16) unsigned DEFAULT NULL COMMENT '上次接待时间',
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='客服代表(csr)配置表';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_leave_message` (
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='用户留言记录';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_reception_log` (
    ...
    `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户(KeFu用户ID)',
    `createtime` bigint(16) unsigned DEFAULT NULL COMMENT '接待时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='客服接待记录';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_trajectory` (
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='用户轨迹表';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_user` (
    ...
    `createtime` bigint(16) unsigned DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='客服用户表';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_blacklist` (
    ...
    `createtime` bigint(16) unsigned DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='客服黑名单表';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_fast_reply` (
    ...
    `deletetime` bigint(16) unsigned DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='快捷回复表';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_toolbar` (
    ...
    `deletetime` bigint(16) unsigned DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='窗口工具栏表';
...
-- 消息推送clientid表
-- ---------------------------
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_user_push_clientid` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
-- 用户验证码表
-- ---------------------------
CREATE TABLE IF NOT EXISTS `__PREFIX__kefu_captcha` (
...
BEGIN;
ALTER TABLE `__PREFIX__kefu_csr_config` MODIFY COLUMN `last_reception_time` bigint(16) UNSIGNED DEFAULT NULL COMMENT '上次接待时间';
ALTER TABLE `__PREFIX__kefu_leave_message` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_reception_log` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '接待时间';
ALTER TABLE `__PREFIX__kefu_record` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_session` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_session` MODIFY COLUMN `deletetime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '删除时间';
ALTER TABLE `__PREFIX__kefu_trajectory` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '添加时间';
ALTER TABLE `__PREFIX__kefu_user` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_blacklist` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_fast_reply` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_fast_reply` MODIFY COLUMN `deletetime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '删除时间';
ALTER TABLE `__PREFIX__kefu_kbs` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_kbs` MODIFY COLUMN `deletetime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '删除时间';
ALTER TABLE `__PREFIX__kefu_toolbar` MODIFY COLUMN `deletetime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '删除时间';
ALTER TABLE `__PREFIX__kefu_user_push_clientid` MODIFY COLUMN `updatetime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '更新时间';
ALTER TABLE `__PREFIX__kefu_captcha` MODIFY COLUMN `createtime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `__PREFIX__kefu_captcha` MODIFY COLUMN `expiretime` bigint(16) UNSIGNED DEFAULT NULL COMMENT '过期时间';
COMMIT;

BEGIN;
ALTER TABLE `__PREFIX__kefu_csr_config` ADD COLUMN `name` varchar(255) COMMENT '用户名' AFTER `id`;
COMMIT;